...
public class TsenaTest {
    protected WebDriver _driver;

    public TsenaTest(WebDriver driver) {
        _driver = driver;
    ...
    public TsenaTest fillContactInfo() {
        ...
        _driver.findElement(By.id("reciever_name")).sendKeys("Irina Gayduk");
        _driver.findElement(By.id("reciever_phone")).sendKeys("+380679090676");
        _driver.findElement(By.id("reciever_email")).sendKeys("ira170925@gmail.com");
